...
detectAreaCode('phone-number-6.wav');
detectAreaCode('phone-number-7.wav');
detectAreaCode('phone-number-8.wav');
detectAreaCode('phone-number-9.wav');
detectAreaCode('phone-number-10.wav');
